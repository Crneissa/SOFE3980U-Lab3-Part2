...
public class BinaryAPIController {
    ...
    public String multiplyString(@RequestParam(name="operand1", required=false, defaultValue="") String operand1,
        ...
        // http://localhost:8080/multiply?operand1=101&operand2=10
    }

    // Multiplies two binary numbers and returns the result as a JSON object
    ...
    public BinaryAPIResult multiplyJSON(@RequestParam(name="operand1", required=false, defaultValue="") String operand1,
        ...
        // http://localhost:8080/multiply_json?operand1=101&operand2=10
    }

    // Performs a bitwise AND operation between two binary numbers and returns the result as a string
    @GetMapping("/and")
    ...
    // Performs a bitwise AND operation between two binary numbers and returns the result as a JSON object
    @GetMapping("/and_json")
    public BinaryAPIResult andJSON(@RequestParam(name="operand1", required=false, defaultValue="") String operand1,
        ...
        // http://localhost:8080/and_json?operand1=1100&operand2=1010
    }

    // Performs a bitwise OR operation between two binary numbers and returns the result as a string
    @GetMapping("/or")
    ...
    // Performs a bitwise OR operation between two binary numbers and returns the result as a JSON object
    @GetMapping("/or_json")
    public BinaryAPIResult orJSON(@RequestParam(name="operand1", required=false, defaultValue="") String operand1,
        ...
        // http://localhost:8080/or_json?operand1=1100&operand2=1010
    }
